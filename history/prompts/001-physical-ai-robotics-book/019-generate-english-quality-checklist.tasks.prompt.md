---
id: 019
title: Generate English Quality Checklist
stage: tasks
date: 2025-12-10
surface: agent
...
labels: ["checklist","english","requirements"]
links:
...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   **HOW TO WRITE CHECKLIST ITEMS - "Unit Tests for English"**:
   ...
   - "Are the exact number and layout of featured episodes specified?" [Completeness, Spec §FR-1]
   ...
   - "Are accessibility requirements defined for keyboard navigation?" [Coverage, Gap]
   - "Does the spec define what happens when logo image fails to load?" [Edge Cases, Gap]
