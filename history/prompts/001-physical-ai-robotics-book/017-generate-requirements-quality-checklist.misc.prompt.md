...
labels: ["requirements", "checklist", "quality"]
links:
  spec: null
  ticket: null
  adr: null
...
```text
i am making a book using docusauras and in that app i have a chatbot with a login using better-auth and see plan.md and select best option
```
